...
band_sizes = [5, 10, 25, 50, 60, 75, 100]# 150, 250, 300, 500]

# Initialize lists to store metrics for each band size
fractions_of_comparisons = []
fractions_of_comparisonsStar = []
...
for bands in band_sizes:
    ...
    fractions_of_comparisons.append(comparisonFrac)
    fractions_of_comparisonsStar.append(comparisonFracStar)
    pair_completeness_values.append(PC)
    pair_quality_values.append(PQ)
    f1_star_scores.append(F1Star)
    f1_scores.append(F1)
...
plt.plot(fractions_of_comparisonsStar, pair_completeness_values)
...
plt.plot(fractions_of_comparisonsStar, pair_quality_values)
plt.xlabel("Fraction of Comparisons")
...
plt.plot(fractions_of_comparisonsStar, f1_star_scores)
plt.xlabel("Fraction of Comparisons")
plt.ylabel("F1* Score")
...
# Plot F1 Score vs Fraction of Comparisons
plt.plot(fractions_of_comparisons, f1_scores)
plt.xlabel("Fraction of Comparisons")
plt.ylabel("F1 Score")
plt.title("F1 Score vs Fraction of Comparisons")
plt.show()
